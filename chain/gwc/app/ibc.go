...
import (
	gatewaymodule "gwc/x/gateway/module"
	gatewaymoduletypes "gwc/x/gateway/types"
...
func (app *App) registerIBCModules(appOpts servertypes.AppOptions) error {
	...
	gatewayIBCModule := gatewaymodule.NewIBCModule(app.appCodec, app.GatewayKeeper)
	ibcRouter.AddRoute(gatewaymoduletypes.ModuleName, gatewayIBCModule)
