// controller/src/experiments/configs/case4-Distribute-TxEvent.config.ts
import { ExperimentConfig } from '../../../types';

/**
 * Test Case 4: Distribute (Available + MultiBurst) + TxEvent
 * (★ 新フォーマットに対応)
 */
const config: ExperimentConfig = {
	description: 'Case 4: Distribute (Available + MultiBurst) + TxEvent',
	iterations: 3,
